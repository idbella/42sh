...
/*   Updated: 2019/12/13 10:00:54 by yelazrak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	ft_strdel(&tmp_hstry);
// 	if (ft_strcmp(&init->out_put[(int)ft_strlen(init->promt)], init->key) == 0 || ((str[0] == 4 &&
...
// 			cmd = ft_strjoin(&init->out_put[(int)ft_strlen(init->promt)], "\n");
